-- Usage:
-- 1. Create test users in Supabase Auth first.
-- 2. Replace the emails below if you used different test accounts.
-- 3. Then run this file with psql or paste it into SQL Editor.
